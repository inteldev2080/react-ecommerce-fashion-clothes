        ...
        <div className={s.mainContainer}>
            ...
            <div className={s.containerPrivacyPolicy}>
                ...
                <p className={s.spacingTopAndBottom}>
                    Your privacy is important to fashion³<br />
                    and we are committed to protecting your personal information. We believe that right to privacy is a basic and fundamental human right. We are NOT in the business of selling your data. This website, www.fashion3.io, is operated by fashioncubed, LLC (“fashion³”, “we” or “us”) located at 7014 13th avenue suite 202, Brooklyn, NY, United States, 11228.
                </p>
                <p className={s.spacingTopAndBottom}>This Privacy Policy (“Policy”) relates to our use of your personal information when you:</p>
                <p className={s.spacingTopAndBottom}>
                    Use our website, microsites or mobile applications and provide us with your personal information, for example by signing up for our newsletters or messages or leaving a review;<br />
                    Register for our rewards program;<br />
                    Purchase products directly from our website;<br />
                    Interact with us through social media, adverts or content on third party websites;<br />
                    Interact with us in person by attending a fashion³ event; and/or<br />
                    Otherwise engage with us, for example by contacting our friendly customer service team (collectively the “Services”).<br />
                ...
                <p className={s.spacingTopAndBottom}>
                    Notice to California Residents: If you are a resident of California, you may have additional rights regarding your personal information as set forth in the “Additional Disclosures for California Residents” below.
                </p>
                <p className={s.spacingTopAndBottom}>
                    This Policy was last updated on and is effective as of September 30, 2022. If you have any questions or concerns about our use of your personal information, then please contact us using the contact details provided in the section below marked “How do I contact fashion³”.
                </p>
                <p className={s.spacingTopAndBottom}>Effective date: September 30 2022</p>
                <p className={s.spacingTopAndBottom}>
            ...
            <div className={s.containerTermsandDefination}>
                ...
                <div className={s.section1}>
                    ...
                    <p className={s.spacingTopAndBottom}>The personal information that we may collect about you broadly falls into the following categories:</p>
                    <p>
                        Information that you provide directly. When you engage with fashion³, we may ask you to share your personal information. We have listed below the categories of personal information we may collect:<br />
                        Identifiers. Such as a real name, alias, postal address, unique personal identifier, online identifier, Internet Protocol address, email address, account name, or other similar identifiers.<br />
                        For example, if you create an account, purchase any products, submit a product review, enter a competition and/or contact our customer service team you may provide your first name, last name, date of birth, gender, email address, mailing address and/or telephone number.<br />
                        When you register for an account, we will also collect information associated with your account such as the date you joined and your order numbers.<br />
                        Personal information categories listed in the California Customer Records statute (Cal. Civ. Code § 1798.80(e)). Such as name, signature, physical characteristics or description, address, telephone number, passport number, driver’s license or state identification card number, insurance policy number, education, employment, employment history, payment card number, or any other financial information. Some personal information included in this category may overlap with other categories.<br />
                        For example, when you place an order and/or contact our customer service department, you may provide your delivery and billing address, credit card type, credit card number and credit card expiration date. We will also collect details of your past orders.<br />
                        Images and photographs. For example, if you enter a competition on the website or via social media when you tag us you may provide a photograph of yourself, or if you engage with us via technologies such as AR, face evaluation or other tools.<br />
                        Your opinions or other information. For example, if you review the products you have purchased from us or provide information about products and/or cosmetic concerns, and the brands and products you use.<br />
                        Protected classification characteristics under California or federal law. - Age (40 years or older), sex (including gender, gender identity, gender expression, sexual orientation, veteran or military status.<br />
                        Commercial information. Records of products or services purchased, obtained, or considered, or other purchasing or consuming histories or tendencies.<br />
                        Information that we collect automatically. When you engage with fashion³ we may use cookies and similar tracking technology to collect the following information about you automatically (for further information please see our Cookies Policy for more information):<br />
                        Internet or other electronic network activity information. Such as browsing history, search history, information on a consumer’s interaction with a website, application, or advertisement.<br />
                        For example, when you visit the website, engage with  fashion³ content or with us digitally, we may collect certain information from your computer, tablet or mobile phone (“Device”) such as your IP address, Device type (i.e. make and model), unique device identification numbers, browser-type and time zone settings<br />
                        We may also collect information about how your Device has interacted with us including: the pages accessed and links clicked; how you navigate to and from the website (such as how you scroll over the site, which parts you click and how long you spend on each page); your preferences, the products and/or services that you have viewed or searched for; and crashes, download errors and response times.<br />
                        Geolocation Data. Such as physical location or movements. We collect your IP address and infer location such as city or postcode therefrom.<br />
                        For example, when you visit the website, engage with fashion³ content or with us digitally, we may collect your broad geographic location (e.g. country or city-level location) from your Device.<br />
                        Inferences drawn from other personal information. Such as a profile reflecting a person's preferences, characteristics, psychological trends, predispositions, behavior, attitudes, intelligence, abilities, and aptitudes.<br />
                        For example, when you visit the website, we may use the personal information indicated above to provide you with tailored advertising, content and products that we think you may like. This is described in further detail in the section below marked “How does fashion³use my personal information?”.<br />
                        Information that we obtain from third party sources. From time to time, we may receive personal information about you from third party sources, but only where we have checked that these third parties either have your consent or are otherwise legally permitted or required to disclose your personal information to us. The types of personal information we collect from third parties includes:<br />
                        Social Media Partners. For example, if you ‘log-in’ to the website using a social medial log in or use functionality such as “like” or “share” buttons, that social media site may pass information to us, including: the user ID for that third party site, the name, email address and location associated with the user ID and any other information permitted under the privacy policy for that website.<br />
                        Retailers, distributors and third party brand partners. For example, where permitted by applicable data protection law and, if applicable, where you have specifically consented, our retailers, distributors and third party brand partners may pass information to us including your first name, last name, email address, postal address, phone number, gender, browsing patterns, geo-location and device identifiers, click through and other cookie data, demographic information including information about your appearance and information in relation to products purchased at their stores (whether on the high-street or online through their own website or a dedicated microsite) and services requested using their websites and/or applications.<br />
                ...
                <div className={s.commonSection}>
                    <h5>3.  FOR WHAT BUSINESS PURPOSE CAN FASHION³ USE MY PERSONAL INFORMATION IN THIS WAY?</h5>
                    <p className={s.spacingOnlyTop}>We are required to satisfy one or more of the reasons set out by applicable data privacy law before we can collect and use your personal information.</p>
                    <p className={s.spacingOnlyTop}>Generally, our business purpose for collecting and using the personal information described above will depend on the personal information concerned and the specific context in which we collect it. However, we will normally rely on the following reasons to collect and use your personal information:</p>
                    <p className={s.spacingOnlyTop}>
                        <span className={s.fontBold}>Performance of a contract</span><br />
                        Using your information may be necessary for us to perform our obligations under a contract with you or with a view to entering into such a contract. For example, where you have: (i) purchased services and/or products from us, we will need to use your information to provide those services and/or products; or (ii) approached us in relation to employment opportunities, the collection and use of your personal information is necessary to enable us to offer you the job role, process your acceptance of the offer, on-board you as an employee and fulfil our obligations as an employer.
                    </p>
                    <p>
                        <span className={s.fontBold}>Compliance with our legal obligations</span><br />
                        The collection and use of your personal information may be necessary to enable us to meet our legal obligations. For example, to verify your identity and undertake necessary due diligence checks.<br />
                        <span className={s.fontBold}>Pursuing our legitimate interests</span><br />
                        Where such processing is not overridden by your interests or fundamental rights, we are permitted to use your personal information where it is necessary in order to pursue our legitimate interests, for example to operate the website and our other digital offerings, to improve our products and services, content and our other digital offerings or to undertake marketing. We may have other legitimate interests and if appropriate we will make this clear to you at the relevant time.<br />
                        <span className={s.fontBold}>Consent</span><br />
                        In some limited circumstances, we may rely on your consent to collect and use your personal information. For example, we may rely on consent: (i) where you have approached us in relation to employment opportunities and have provided us with sensitive personal information, such as information in relation to your racial and ethnic origin, sexual orientation, religion, physical and mental health, disabilities or trade union membership; or (ii) in relation to the sending of e-marketing or communications.<br />
                        If we rely on consent, this will be made clear to you at the time we request your information. You can withdraw your consent at any point by using the mechanism provided at the time, or by contacting us using the contact details provided in the section “How do I contact fashion³ ?” of this Policy.<br />
                        <span className={s.fontBold}>Vital interests</span><br />
                        In some instances, we may need to use your personal information to protect your vital interests or those of another person.<br />
                    ...
                    <p className={s.spacingOnlyTop}>
                        If we collect and use your personal information in reliance on our legitimate interests (or those of any third party), these interests will normally be as set out in this Policy; however, if this changes we will make clear to you at the relevant time what those legitimate interests are.
                    </p>
                    <p className={s.spacingOnlyTop}>
                        If you have any questions or need further information concerning the business purpose on which we collect and use your personal information, please contact us using the contact details provided in the section below marked “How do I contact fashion³ ?"
                    </p>
                </div>
                <div className={s.commonSection}>
                    <h5>4.  DOES FASHION³ SHARE MY PERSONAL INFORMATION WITH ANYONE?</h5>
                    <p className={s.spacingOnlyTop}>
                        During the past 12 months, we may have disclosed the categories of personal information listed in the section marked “what categories of personal information does fashion³ collect about me?” to the following categories of recipients:
                    </p>
                    <p className={s.spacingOnlyTop}>
                        With our affiliates – We may make your personal information available to fashion³ affiliated companies to allow us to provide our products and services to you, for the purposes described in this Policy, or as notified to you when we collect your personal information.
                    </p>
                    <p className={s.spacingOnlyTop}>
                    ...
                    <p className={s.spacingOnlyTop}>
                        With our service providers - We engage third party service providers to perform functions on our behalf (for example, to support the delivery of our products, or the website). This includes but is not limited to sharing information with the following types of service providers:<br />
                        advertising providers - including companies that provide: (i) advertising space for fashion³; (ii) the provision of advertising related services, including agencies instructed to make advertising purchases on our behalf , providers of ad-exchanges (a digital marketplace to buy and sell advertising space) and providers of a demand-side platform (software used to purchase advertising in an automated fashion), such as Message Media from Google;<br />
                        providers of marketing and customer relationship management databases and data management platforms – that enable fashion³ to manage your information in a safe and efficient manner;
                        data analysis firms –that provide insights and help us to analyze trends using the data that we and they hold;<br />
                        customer support specialists –that provide customer support services on our behalf for fashion³ products and services;<br />
                        fulfilment companies –this includes companies that manage your orders and ship your products, coordinate email campaigns, sweepstakes, contests or promotions on our behalf;<br />
                        application development and web-hosting companies – to enable us to manage and improve the website;<br />
                        information technology and related infrastructure providers;<br />
                        email delivery providers; and<br />
                        audit and professional service providers.<br />
                        As part of a business transfer – fashion³ may disclose your personal information to an actual or potential buyer (and its agents and advisers) in relation to any actual or proposed divestiture, merger, acquisition, joint venture, bankruptcy, dissolution, reorganization, or any other similar transaction or proceeding.<br />
                        To comply with laws – fashion³may disclose your personal information to any competent law enforcement body, regulatory, government agency, court or other third party where we believe disclosure is necessary (i) as a matter of applicable law or regulation, (ii) to exercise, establish or defend our legal rights, or (iii) to protect your vital interests or those of any other person; and To any other person with your consent to the disclosure.
                    </p>
                </div>
                <div className={s.commonSection}>
                    <h5>5.  WHAT ARE MY DATA PROTECTION RIGHTS?</h5>
                    <p>
                        fashion³ respects your right to access and control your personal information. You have choices about the data we collect. When you are asked to provide personal information that is not necessary for the purposes of providing you with our Services, you may decline. However, if you choose not to provide data that is necessary to provide a Service, you may not have access to certain features or Services.
                    </p>
                    <p className={s.spacingOnlyTop}>
                        We aim to keep all personal information that we hold accurate, complete and up-to-date. While we will use our best efforts to do so, we encourage you to tell us if you change your contact details. However, if you believe that the information we hold about you is incorrect, incomplete or out-of-date, please contact us at hello@fashion3.io.
                    </p>
                    <p className={s.spacingOnlyTop}>
                ...
                <div className={s.commonSection}>
                    ...
                    <p className={s.spacingOnlyTop}>
                        We may use your personal information to identify you on Social Sites and to show you ads that are more relevant for you. The Social Sites will not share your personal information with other parties and will delete the information promptly after the matching process is complete.
                    </p>
                    <p className={s.spacingOnlyTop}>
                        Our use of your personal information in relation to the Social Sites will be as set out in this Policy or as otherwise notified to you. Again, please note that third party sites (including the Social Sites) may be under the control of a third party and we encourage you to familiarize yourself with the privacy policies and terms of use of each third party site.
                    </p>
                </div>
                <div className={s.commonSection}>
                    <h5>8.  HOW DO I STOP RECEIVING MARKETING COMMUNICATIONS?</h5>
                    <p className={s.spacingOnlyTop}>
                        We will only send you marketing communications if you have agreed to this, or if we are otherwise permitted by law. If at any time you decide that you no longer wish to receive marketing communications from us, you may opt out by clicking on the relevant ‘unsubscribe’ link in the emails you receive, by texting STOP in response to any text message or by contacting us using the details found in the section “How do I contact fashion³?”.
                    </p>
                    <p className={s.spacingOnlyTop}>
                ...
                <div className={s.commonSection}>
                    ...
                    <p className={s.spacingOnlyTop}>
                        We will retain your personal information where we have an ongoing legitimate business need to do so (for example, to provide you with access to the fashion3.io or other digital offerings, to provide you with a product you have purchased, or to comply with applicable legal, tax, or accounting requirements).
                    </p>
                    <p className={s.spacingOnlyTop}>
                ...
                <div className={s.commonSection}>
                    <h5>10.  DOES FASHION³ TRANSFER MY PERSONAL INFORMATION TO OTHER COUNTRIES?</h5>
                    <p className={s.spacingOnlyTop}>
                    ...
                    <p className={s.spacingOnlyTop}>
                        Further information can be provided on request: please contact us using the details found in the section “How do I contact fashion³ ?" We have also implemented similar appropriate safeguards with our third party service providers and partners and further details can be provided upon request.
                    </p>
                </div>
                <div className={s.commonSection}>
                ...
                <div className={s.commonSection}>
                    <h5>12.  I HAVE ENTERED A CONTEST, PROMOTION OR SURVEY – HOW DO I FIND OUT MORE ABOUT THAT?</h5>
                    <p className={s.spacingOnlyTop}>
                        fashion³ and its preferred third party service providers or business partners may offer sweepstakes, contests, promotions and surveys (each, a "Promotion").
                    </p>
                    <p className={s.spacingOnlyTop}>
                ...
                <div className={s.commonSection}>
                    <h5>13.  HOW OLD DO I HAVE TO BE TO USE THE FASHION³ SITES OR OTHER DIGITAL OFFERINGS?</h5>
                    <p className={s.spacingOnlyTop}>
                        You must be aged 13 or over to use the fashion³ sites and our other digital offerings.
                    </p>
                    <p className={s.spacingOnlyTop}>
                ...
                <div className={s.commonSection}>
                    ...
                    <p className={s.spacingOnlyTop}>
                        We have taken great measures to ensure that your visit to the website is an excellent one and that your privacy is respected. If you have any questions, comments, or concerns about our privacy practices and/or would like to submit a privacy request, please contact us either:
                    </p>
                    <p className={s.spacingOnlyTop}>
                        Via email at hello@fashion3.io.com and/or<br />
                        Via postal mail at: FASHIONCUBED LLC, Attn: Privacy Issues, 7014 13th avenue suite 202, Brooklyn, NY, United States, 11228.
                    </p>
                </div>
                <div className={s.commonSection}>
                    ...
                    <p className={s.spacingOnlyTop}>
                        We may disclose your personal information to a third party for a business purpose. When we disclose personal information for a business purpose, we enter a contract that describes the purpose and requires the recipient to both keep that personal information confidential and not use it for any purpose except performing the contract. For more information on how we share personal information, including the categories of third-parties with which we share personal information, please see the “Does fashion³ share my personal information with anyone?” section above.
                    </p>
                    <p className={s.spacingOnlyTop}>
                    ...
                    <p className={s.spacingOnlyTop}>
                        ...
                        California Civil Code Section 1798.83 permits users who are California residents to obtain from us once a year, free of charge, a list of third parties to whom we have disclosed personal information (if any) for direct marketing purposes in the preceding calendar year. If you are a California resident and you wish to make such a request, please send an e-mail with “California Privacy Rights” in the subject line to hello@fashion3.io or write us at: FASHIONCUBED LLC, Attn: California Privacy Rights, 7014 13th avenue suite 202, Brooklyn, NY, United States, 11228.
                    </p>
                    <p className={s.spacingOnlyTop}>
                        Contact Information<br />
                        If you have any questions or comments about this notice, the ways in which we collect and use your information described in this Policy, your choices and rights regarding such use, or wish to exercise your rights under California law, please do not hesitate to contact us at
                    </p>
                </div>
                <div>
